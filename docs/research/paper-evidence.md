...
The first command emits the exact tracked result in [`evaluation/results/mothership-0.2.1.json`](../../evaluation/results/mothership-0.2.1.json). The corpus is [`evaluation/corpus/protocol-validation.v1.json`](../../evaluation/corpus/protocol-validation.v1.json).
