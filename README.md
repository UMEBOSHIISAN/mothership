...
<p align="center">
  <img src="assets/mothership-flight-recorder-social.png" alt="Whale-shaped Mothership tracing a linked evidence path through deep space" width="100%">
</p>

<p align="center">
  <img src="assets/flight-demo.gif" alt="Real Mothership CLI demo comparing a complete run with detected scope drift" width="100%">
</p>
...
<p align="center">
  <img src="assets/flight-incident.svg" alt="Declared success recomputed as drift when the execution action class exceeds approval" width="100%">
</p>
...
<p align="center">
  <img src="assets/flight-lifecycle.svg" alt="Eight required linked stages from intent through persistence proof" width="100%">
</p>
...
Part of the Mothership constellation means independently adoptable components with explicit boundaries. Mothership does
not install, invoke, or configure a companion. The constellation is a discovery and composition map, not an installed
dependency, an authority grant, or an automatic integration.
...
If evidence-backed agent operations should be easier to inspect, replay, and challenge, [star Mothership](https://github.com/UMEBOSHIISAN/mothership).
Every star helps more builders find the black box before they need it.
